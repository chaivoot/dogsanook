...
export const site = {
  ...
  zones: ['รามคำแหง', 'สวนหลวง', 'พระราม 9', 'ลาดกระบัง'],
...
export const seo = {
  ...
  description:
    'ครูฝึกสุนัขถึงบ้าน สไตล์เล่นไปฝึกไป ไม่ดุ ไม่บังคับ สอนน้องเรียกแล้วมา ปูพื้นฐานลูกหมา มารยาทในบ้าน บริการโซนรามคำแหง สวนหลวง พระราม 9 ลาดกระบัง — ปรึกษาฟรีทาง LINE',
  keywords: [
    'ครูฝึกสุนัขถึงบ้าน',
