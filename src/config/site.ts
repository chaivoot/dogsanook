...
export const site = {
  ...
  heroVideo: {
    ...
    uploadDate: '2026-07-10T19:36:00+07:00', // จริง = วันที่คลิปขึ้นเว็บครั้งแรก · ISO 8601 + timezone (Google ต้องการ)
    duration: 'PT22S',
  },
...
export const seo = {
  ...
  description:
    'ครูฝึกสุนัขถึงบ้าน โซนกรุงเทพกรีฑา รามคำแหง — ฝึกหมาตามหลักวิทยาศาสตร์ ผ่านการเล่น ไม่ดุ ไม่บังคับ สอนน้องเรียกแล้วมา ปูพื้นฐานลูกหมา ปรึกษาฟรีทาง LINE',
  keywords: [
    'ฝึกสุนัข',
    'ฝึกหมา',
    'ฝึกหมาตามหลักวิทยาศาสตร์',
